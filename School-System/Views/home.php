...
<body>
  <!-- <video autoplay muted loop id="bg-video">
    <source src="/Assets/video/Universidad Católica de Santa María  UCSM.mp4" type="video/mp4">
  </video> -->
      ...
      <div class="col-md-4 col-md-offset-4 col-centered">
        <div class="login-panel">
          <form method="POST" autocomplete="off" role="form">
            ...
            <div class="login-panel-section button-container">
              <button type="submit" name='login' class="btn btn-default">
                <i class="fa fa-sign-in fa-fw" aria-hidden="true"></i> Iniciar sesión</button>
            </div>
          </form>
        </div>
      </div>
