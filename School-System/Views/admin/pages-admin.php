...
<head>
  ...
  <title>UCSM | Sistema Escolar</title>
  <!-- Bootstrap CSS -->
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Estudiantes recientes<a href="../students/mostrar.php" class="btn btn-success btn-sm">Ver todos</a></h5>
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Docentes recientes<a href="../teachers/mostrar.php" class="btn btn-success btn-sm">Ver todos</a></h5>
