			...
			<div class="row">
				...
				<nav class="hidden-xs scroll-navigation-ins">
					<figure class="full-reset">
						<img src="assets/img/logoucsm.png" alt="Logo" class="img-responsive center-box">
					</figure>
		...
		<div class="full-reset" style="padding: 15px 0;">
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12">
						<div class="full-reset footer-copyright"><i class="fa fa-copyright"></i> 2024 - Creador Education Group</div>
					</div>
				</div>
			</div>
		</div>
