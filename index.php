...
<body>
	...
	<header class="full-reset header">
		...
		<div class="full-reset logo">
			<span class="hidden-lg hidden-md">UCSM</span>
			<span class="hidden-xs hidden-sm"><a style="color: #fff; text-decoration: none;" href="index.php">UCSM - Universidad C. de Santa María</a></span>
		</div>
		<!--======================================== Links de navegación ========================================-->
		<nav class="full-reset navigation">
			<ul class="full-reset list-unstyled">
				...
				<li><a href="bachilleratos.php">Bachilleratos</a></li>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-4">
						...
						<ul class="list-unstyled full-reset">
							...
							<li><a href="School-System/index.php" class="open-link-newTab"><i class="fa fa-graduation-cap"></i>&nbsp; Plataforma (MOODLE)</a></li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-4">
	...
	<!--======================================== Logo & Lema ========================================-->
	<section class="full-reset font-cover" style="background-image: url(assets/img/bienvenidos\ ucsm_fondo.jpg);">
		<div class="full-reset" style="height: 100%; background-color: rgba(255,255,255,.6); padding: 60px 0;">
			<h1 class="text-center titles">UN PILAR JUNTO CON LA CORONA REAL</h1>
			<figure class="Logo-Ins-Index">
				<img src="assets/img/logoucsm.png" alt="Logo" class="img-responsive">
			</figure>
			<p class="lead text-center">
				"Representa a la Virgen del Pilar, quien se le apareció al R.P. <br> Chaminade, fundador de la sociedad de María, en Zaragoza, España."
			</p>
		</div>
	</section>
	...
	<section class="full-reset" style="padding: 40px 0;">
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-sm-push-6">
					...
					<a href="galeria.php" class="open-link-newTab">Has click aqui para ver las fotos</a>
					</p>
					<img src="assets/gallery/font-index.jpg" alt="Default" class="small-image">
					<br>
				</div>
					...
					<div id="slider-ins" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner" role="listbox">
					    ...
					    <div class="item active">
					      <img src="assets/gallery/font-index.jpg" alt="Default">
						...
						<!-- Segunda imagen -->
					    <div class="item">
					      <img src="assets/gallery/logoucsm.png" alt="Default">
					      <div class="carousel-caption">
					        Lorem ipsum dolor sit amet
					      </div>
					    </div>
	...
	<section class="full-reset" style="background-color: #F7F7F7; padding: 40px 0;">
		 <div class="container">
			<!--======================================== Video ========================================-->
			<div class="row">
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<article class="col-xs-12 col-sm-6 col-md-4">
					<div class="thumbnail">
				      <img src="assets/gallery/logoucsm.png" alt="IMG" class="img-responsive img-rounded">
				      <div class="caption">
	...
	<section class="text-center important-links-index">
		...
		<a href="School-System/index.php" class="open-link-newTab">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-4">
						...
						<p class="text-center">Campus Central Urb. San José S/N <br> Umacollo Arequipa - Perú</p>
					</div>
					<div class="col-xs-12 col-sm-4">
						<h4 class="titles text-center">Contactenos</h4>
						<p class="text-center">Telefono: 054-382038 <br>Correo Electrónico: correo@hotmail.com</p>
					</div>
					<div class="col-xs-12 col-sm-4">
						<h4 class="titles subtitles-footer">Siguenos en</h4>
						<ul class="list-unstyled links-footer">
							<li><a href="https://www.facebook.com/ucsm.edu.pe" class="open-link-newTab"><i class="fa fa-facebook"></i> &nbsp; Facebook</a></li>
							<li><a href="https://www.youtube.com/user/UCSMAREQUIPA" class="open-link-newTab"><i class="fa fa-youtube"></i> &nbsp; YouTube</a></li>
							<li><a href="https://www.linkedin.com/school/universidad-catolica-de-santa-maria/?originalSubdomain=pe" class="open-link-newTab"><i class="fa fa-linkedin"></i> &nbsp; Linkedin</a></li>
						</ul>
					</div>
					<div class="col-xs-12">
						<div class="full-reset footer-copyright"><i class="fa fa-copyright"></i>2024 - Creado por Education Group</div>
					</div>
				</div>
			</div>
		</div>
